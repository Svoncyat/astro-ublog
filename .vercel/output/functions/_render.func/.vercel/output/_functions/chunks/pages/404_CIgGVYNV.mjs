import { c as createAstro, d as createComponent, r as renderTemplate, e as addAttribute, f as renderSlot, g as renderHead, h as renderComponent, m as maybeRenderHead, F as Fragment, u as unescapeHTML } from '../astro_BOFBhy_c.mjs';
import 'kleur/colors';
/* empty css                          */
import 'clsx';
/* empty css                        */
...
const SITE = {
  ...
  author: "Joy Correa",
  desc: "Un Portafolio de mis proyectos universitarios",
  title: "Blog | Joy Correa",
...
}, "C:/Workspaces/Cloned/astro-ublog/node_modules/.pnpm/astro@4.5.12_@types+node@20.12.2_typescript@5.4.3/node_modules/astro/components/ViewTransitions.astro", void 0);
...
const $$Layout = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Layout;
  const googleSiteVerification = {"BASE_URL": "/", "MODE": "production", "DEV": false, "PROD": true, "SSR": true, "SITE": "https://astro-paper.pages.dev/", "ASSETS_PREFIX": undefined}.PUBLIC_GOOGLE_SITE_VERIFICATION;
  const {
    title = SITE.title,
    author = SITE.author,
...
}, "C:/Workspaces/Cloned/astro-ublog/src/layouts/Layout.astro", void 0);
...
}, "C:/Workspaces/Cloned/astro-ublog/src/components/Hr.astro", void 0);
...
}, "C:/Workspaces/Cloned/astro-ublog/src/components/LinkButton.astro", void 0);
...
const $$Header = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<header class="astro-3ef6ksr2"> <a id="skip-to-content" href="#main-content" class="astro-3ef6ksr2">¡Sáquenme de latinoamérica!</a> <div class="nav-container astro-3ef6ksr2"> <div class="top-nav-wrap astro-3ef6ksr2"> <a href="/" class="logo whitespace-nowrap astro-3ef6ksr2"> ${renderTemplate`<img${addAttribute(`/assets/${"logo.svg" }`, "src")}${addAttribute(SITE.title, "alt")} width="210" height="210" class="astro-3ef6ksr2">` } </a> <nav id="nav-menu" class="astro-3ef6ksr2"> <button class="hamburger-menu focus-outline astro-3ef6ksr2" aria-label="Open Menu" aria-expanded="false" aria-controls="menu-items"> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="menu-icon astro-3ef6ksr2"> <line x1="7" y1="12" x2="21" y2="12" class="line astro-3ef6ksr2"></line> <line x1="3" y1="6" x2="21" y2="6" class="line astro-3ef6ksr2"></line> <line x1="12" y1="18" x2="21" y2="18" class="line astro-3ef6ksr2"></line> <line x1="18" y1="6" x2="6" y2="18" class="close astro-3ef6ksr2"></line> <line x1="6" y1="6" x2="18" y2="18" class="close astro-3ef6ksr2"></line> </svg> </button> <ul id="menu-items" class="display-none sm:flex astro-3ef6ksr2"> <li class="astro-3ef6ksr2"> <a href="/posts/"${addAttribute((activeNav === "posts" ? "active" : "") + " astro-3ef6ksr2", "class")}>
Publicaciones
...
}, "C:/Workspaces/Cloned/astro-ublog/src/components/Header.astro", void 0);
...
}, "C:/Workspaces/Cloned/astro-ublog/src/components/Socials.astro", void 0);
...
const $$Footer = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<footer${addAttribute(`${noMarginTop ? "" : "mt-auto"} astro-sz7xmlte`, "class")}> ${renderComponent($$result, "Hr", $$Hr, { "noPadding": true, "class": "astro-sz7xmlte" })} <div class="footer-wrapper astro-sz7xmlte"> ${renderComponent($$result, "Socials", $$Socials, { "centered": true, "class": "astro-sz7xmlte" })} <div class="copyright-wrapper astro-sz7xmlte"> <span class="astro-sz7xmlte">Copyright &#169; ${currentYear}</span> <span class="separator astro-sz7xmlte">&nbsp;|&nbsp;</span> <span class="astro-sz7xmlte">All rights reserved. Jocori SAC</span> </div> </div> </footer> `;
}, "C:/Workspaces/Cloned/astro-ublog/src/components/Footer.astro", void 0);

const $$Astro = createAstro("https://astro-paper.pages.dev/");
const $$404 = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$404;
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": `404 Not Found | ${SITE.title}`, "class": "astro-zetdm5md" }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "Header", $$Header, { "class": "astro-zetdm5md" })} ${maybeRenderHead()}<main id="main-content" class="astro-zetdm5md"> <div class="not-found-wrapper astro-zetdm5md"> <h1 aria-label="404 Not Found" class="astro-zetdm5md">404</h1> <span aria-hidden="true" class="astro-zetdm5md">¯\\_(ツ)_/¯</span> <p class="astro-zetdm5md">Página no encontrada</p> ${renderComponent($$result2, "LinkButton", $$LinkButton, { "href": "/", "className": "my-6 text-lg underline decoration-dashed underline-offset-8 astro-zetdm5md" }, { "default": ($$result3) => renderTemplate`
Ir a Inicio
` })} </div> </main> ${renderComponent($$result2, "Footer", $$Footer, { "class": "astro-zetdm5md" })} ` })} `;
}, "C:/Workspaces/Cloned/astro-ublog/src/pages/404.astro", void 0);

const $$file = "C:/Workspaces/Cloned/astro-ublog/src/pages/404.astro";
const $$url = "/404";
